...
function GM:HUDPaint()
   ...
   //Spectator HUD
      if HUD_DEBUG[12] then
         ...
         draw.SimpleText("Additional respawns are created every minute, if none are available.","TabLarge", ScrW()/2, ScrH()-85,Color(255,255,255,255),TEXT_ALIGN_CENTER,TEXT_ALIGN_BOTTOM,2,Color(80,80,80,255))
