...
local function RoleChatRecv(um)
   ...
   chat.AddText(Color( 255, 30, 40 ), "(ALIEN CHAT) ", Color( 255, 200, 20), sender:GetFName(), Color( 255, 255, 200), ": " .. text) 
   
   local steamid = um:ReadString()
   print("chat message by:", steamid)
end
usermessage.Hook("alien_chat", RoleChatRecv)

local function RecieveOOCChat(UM)
	local name,text,steamid
	...
	chat.AddText(Color(255,130,0),"(ALL) ",Color(225,0,0),realname,":",Color(255,255,255),text)
	print("chat message by:", steamid)
end
...
local function RecieveSpecChat(UM)
	...
	chat.AddText(Color(0,200,0),"[SPEC] ",Color(255,255,0),name,":",Color(255,255,255),text)
	print("chat message by:", steamid)
end
