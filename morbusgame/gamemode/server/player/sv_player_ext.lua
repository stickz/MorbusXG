...
function plymeta:DeathSound() -- TO DO
   ...
   elseif self.Gender == GENDER_FEMALE || self.Gender == GENDER_MALE then
...
function plymeta:SetRegenSanity(k)
	self.RegenSanity = k
end

function plymeta:GetRegenSanity()
   return self.RegenSanity
end
...
function plymeta:GetBaseSanity()
   return self:GetNWFloat("sanity", 1000)
end
...
function plymeta:SetTBroodPoints(k)
	self.TotalBroodPoints = k
end

function plymeta:GetTBroodPoints()
   return self.TotalBroodPoints
end