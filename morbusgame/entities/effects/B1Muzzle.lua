...
function EFFECT:Render()
	...
	for i = 1, 2 do
		render.DrawSprite( pos, self.Size, self.Size, Color( 255, 215, 155, alpha ) )
		render.StartBeam( 2 )
		render.AddBeam( pos - ang:Forward() * 12, 16, 0, Color( 255, 215, 55, alpha ) )
		render.AddBeam( pos + ang:Forward() * 12, 16, 1, Color( 255, 215, 55, 0 ) )
		render.EndBeam()
	end
end
