...
if ( CLIENT ) then
	language.Add ("ent_incendiary_grenade", "Incendiary Grenade") --wtf
...
SWEP.GrenadeEnt = "ent_incendiary_grenade"
SWEP.GrenadeWep = "weapon_incendiary"
...
SWEP.VElements = {
	...
	material = "reskins/masseffect/grenade_incendiary", 
	skin = 0, 
	bodygroup = {} 
	}
}
