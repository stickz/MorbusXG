...
if ( CLIENT ) then
	language.Add ("ent_cryo_grenade", "Cryo Grenade") --wtf
	SWEP.DrawCrosshair		= true
	SWEP.ViewModelFOV       = 70
	SWEP.ViewModelFlip		= false
	SWEP.CSMuzzleFlashes	= false
	SWEP.PrintName			= "Cryo Grenade"
...
SWEP.GrenadeEnt = "ent_cryo_grenade"
SWEP.GrenadeWep = "weapon_cryo"
...
SWEP.VElements = {
	["a"] = { 
	   ...
	   material = "reskins/masseffect/grenade_cryo", 
	   skin = 0, bodygroup = {} 
	}
}
