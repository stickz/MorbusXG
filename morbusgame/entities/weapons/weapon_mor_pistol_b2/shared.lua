...
SWEP.PrintName 		  = "Arc Blaster" -- Jarvis

if (CLIENT) then
	SWEP.PrintName 		= "Arc Blaster"
	SWEP.Slot 			= 1
	SWEP.SlotPos 		= 1
	SWEP.IconLetter     = "b"
...
SWEP.CustomModel 	=	"models/mass_effect_3/weapons/pistols/arc pistol.mdl"
SWEP.CustomMaterial	=	"models/mass_effect_3/weapons/pistols/arc pistol/wpn_psth_diff"
...
SWEP.Primary.Sound 		   = Sound("pulsar2.Single3")
...
function SWEP:ShootBullet(damage, recoil, num_bullets, aimcone, charge)
    ...
    local ent = ents.Create( "mor_energybolt_pulse" )
    ...
    self.Weapon:EmitSound("phaser.Single", 135, 100)
