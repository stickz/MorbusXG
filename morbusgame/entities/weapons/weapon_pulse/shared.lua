...
if ( CLIENT ) then
	language.Add ("ent_pulse_grenade", "Pulse Grenade") --wtf
...
SWEP.GrenadeEnt = "ent_pulse_grenade"
SWEP.GrenadeWep = "weapon_pulse"
...
SWEP.VElements = {
	...
	material = "reskins/masseffect/grenade_pulse", 
	skin = 0, 
	bodygroup = {} 
	}
}
